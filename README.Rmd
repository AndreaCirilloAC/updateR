...
To update R, run `updateR()` with your system password. The function will display the version that R has been updated to when it finishes. 
**previously installed packages will be installed back from CRAN and Bioconductor, ( this may require time)**
